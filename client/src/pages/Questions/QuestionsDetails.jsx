...
import { postAnswer,postComment, deleteQuestion,voteQuestion } from '../../actions/question'
// import plugin from '../../actions/plugin'
...
const QuestionsDetails = () => {
    ...
    const handlePostComment= (e, commentLength) =>{
        e.preventDefault()
        if(User === null){
            alert('Login or Signup to comment on a question')
            Navigate('/Auth')
        }else{
            if(Comment === ''){
    ...
    return (
        ...
        <form onSubmit={ (e) => { handlePostComment(e, question.comment.length) }}>
        
            <textarea  placeholder='Add your comment' onChange={e => setComment(e.target.value)} > </textarea>
        ...
        question.noOfComments !== 0 && (
            <section>
                ...
                <EditForm key={question._id} question={question} />
            </section>
        )
    }
